...
| Existing releases remain production | Migration `0023_release_channels.sql`; installed records default missing channel to prod; legacy upload retries preserve their hash and storage filename | Migration and legacy pending/accepted upload retry tests |
